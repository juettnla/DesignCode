...
//  DesignCode
//
//  Created by Lars Juettner on 06.04.20.
//  Copyright © 2020 Lars Juettner. All rights reserved.
//
...
struct BottomCardView: View {
    var body: some View {
        VStack(spacing: 20) {
            ...
            Text("This certificate is proof that Lars Juettner has achieved the UI Design Course with approval from a Design+Code instructor. ")
